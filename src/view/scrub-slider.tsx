...
export function ScrubSlider({
  ...
  return (
    <div className="relative w-full">
      ...
      <div ref={trackRef} className="relative flex h-4 w-full touch-none select-none items-center">
        ...
        <div className="pointer-events-none relative h-[3px] w-full rounded-full bg-accent/15">
          {/* Range fill */}
          <div
            className="pointer-events-none absolute h-full rounded-full bg-accent/60"
            style={{ width: `${percent}%` }}
          />
        </div>
        {/* Thumb */}
